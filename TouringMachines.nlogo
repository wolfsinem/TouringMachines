...
to simulation
  ...
  while [ticks < max-ticks] [
    if ticks = 20 [ask target [set speed 0.1]]
    go
  ]
end
@#$#@#$#@
...
"" ""
PENS
"Speed Red car" 1.0 0 -2674135 true "" "plot [speed] of target"
"Minimum Speed Cars" 1.0 0 -13791810 true "" "plot min [speed] of turtles"
